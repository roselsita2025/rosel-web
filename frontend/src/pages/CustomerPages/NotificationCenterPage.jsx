...
const NotificationCenterPage = () => {
    ...
    return (
        <>
            <div className="min-h-screen bg-[#f8f3ed] pt-32 pb-8">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8">
                        <div className="flex items-center justify-between">
                            <div>
                                <h1 className="text-3xl font-bold text-[#860809] font-libre">Notifications</h1>
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-start justify-between">
                                                <div className="flex-1">
                                                    <h3 className="text-lg font-medium text-[#860809] mb-1 font-libre">
                                                        {notification.title}
                                                    </h3>
