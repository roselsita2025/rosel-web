            ...
            <div className='mx-auto max-w-screen-xl px-3 sm:px-4 md:px-6 lg:px-8 2xl:px-0'>
                ...
                <div className='grid grid-cols-1 gap-6 sm:gap-8 lg:grid-cols-3'>
                    ...
                    >
                        ...
                        <div className='rounded-lg border border-gray-300 p-4 sm:p-6 bg-[#fffefc] shadow-md'>
                            ...
                            <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6'>
                                ...
                                <div>
                                    ...
                                    <div className='space-y-1'>
                                        <div className='flex items-center gap-2'>
                                            <Mail className='w-3 h-3 sm:w-3.5 sm:h-3.5 flex-shrink-0' style={{ color: '#860809' }} />
                                            <span className='text-xs sm:text-sm text-[#030105] font-libre break-all'>{shippingInfo.email}</span>
                                        </div>
                                        <div className='flex items-center gap-2'>
                                            <Phone className='w-3 h-3 sm:w-3.5 sm:h-3.5 flex-shrink-0' style={{ color: '#860809' }} />
                                            <span className='text-xs sm:text-sm text-[#030105] font-libre'>{shippingInfo.phone}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {/* Shipping Address */}
                                <div>
                                    <h3 className='text-xs sm:text-sm font-medium mb-1.5 sm:mb-2 text-[#a31f17] font-alice'>Ship to</h3>
                                    <div className='space-y-1'>
                                        <div className='flex items-start gap-2'>
                                            <MapPin className='w-3 h-3 sm:w-3.5 sm:h-3.5 mt-0.5 flex-shrink-0' style={{ color: '#860809' }} />
                                ...
                                >
                                    <div className='flex items-center justify-between gap-2'>
                                        <div className='flex items-center gap-2 sm:gap-3 flex-1 min-w-0'>
                                            <div className={`w-3.5 h-3.5 sm:w-4 sm:h-4 rounded-full border-2 flex-shrink-0 ${
                                                selectedShipping === 'pickup' 
                                            ...
                                            <div className='flex items-center gap-1.5 sm:gap-2 flex-1 min-w-0'>
                                                <Store className='w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0' style={{ color: '#860809' }} />
                                                <div className='flex-1 min-w-0'>
                                                    <h3 className='font-medium text-[#030105] font-alice text-sm sm:text-base'>Pick Up in Store</h3>
                                                    <p className='text-xs sm:text-sm text-[#a31f17] font-libre'>Free pickup at our location</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className='text-right flex-shrink-0'>
                                            <div className='font-semibold text-green-600 font-libre text-sm sm:text-base'>FREE</div>
                                            <div className='text-xs text-[#a31f17] font-libre hidden sm:block'>No additional cost</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                >
                                    <div className='flex items-center justify-between gap-2'>
                                        <div className='flex items-center gap-2 sm:gap-3 flex-1 min-w-0'>
                                            ...
                                            <div className='flex items-center gap-1.5 sm:gap-2 flex-1 min-w-0'>
                                                <Truck className='w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0' style={{ color: '#860809' }} />
                                                <div className='flex-1 min-w-0'>
                                                    <h3 className='font-medium text-[#030105] font-alice text-sm sm:text-base'>Lalamove Delivery</h3>
                                                    <p className='text-xs sm:text-sm text-[#a31f17] font-libre'>Door-to-door delivery service</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className='text-right flex-shrink-0'>
                                            {isLoadingQuote ? (
                                                <div className='flex items-center gap-1.5 sm:gap-2'>
                                                    <div className='w-3.5 h-3.5 sm:w-4 sm:h-4 border-2 border-[#f8f3ed] border-t-[#901414] rounded-full animate-spin'></div>
                                                    <span className='text-xs sm:text-sm text-[#a31f17] font-libre hidden sm:inline'>Loading...</span>
                                                </div>
                                            ) : lalamoveQuote ? (
                                                <div>
                                                ...
                                                <div className='flex flex-col items-end gap-1'>
                                                    <div className='text-xs sm:text-sm text-red-500'>Quote unavailable</div>
                                                    <button
                                                        onClick={fetchLalamoveQuote}
                                                        className='text-xs px-1.5 sm:px-2 py-0.5 sm:py-1 rounded bg-red-100 text-red-600 hover:bg-red-200 transition-colors'
                                                    >
                                                        Retry
                                                    </button>
                                                </div>
                                    ...
                                    {selectedShipping === 'lalamove' && lalamoveQuote && (
                                        <div className='mt-3 sm:mt-4 p-2.5 sm:p-3 rounded-lg bg-[#f8f3ed]'>
                                            <div className='grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 text-xs sm:text-sm'>
                                                <div>
                                                    <span className='font-medium text-[#030105] font-alice'>Service Type:</span>
                                                    <span className='ml-1.5 sm:ml-2 text-[#a31f17] font-libre'>{lalamoveQuote.serviceType}</span>
                                                </div>
                                                <div>
                                                    <span className='font-medium text-[#030105] font-alice'>Distance:</span>
                                                    <span className='ml-1.5 sm:ml-2 text-[#a31f17] font-libre'>{lalamoveQuote.distance?.toFixed(1) || 0} km</span>
                                                </div>
                                                <div>
                                                    <span className='font-medium text-[#030105] font-alice'>Estimated Time:</span>
                                                    <span className='ml-1.5 sm:ml-2 text-[#a31f17] font-libre'>{Math.round(lalamoveQuote.duration || 0)} min</span>
                                                </div>
                                                <div>
                                                    <span className='font-medium text-[#030105] font-alice'>Total Weight:</span>
                                                    <span className='ml-1.5 sm:ml-2 text-[#a31f17] font-libre'>{lalamoveQuote.totalWeight || 0} kg</span>
                                                </div>
                                            </div>
                                        </div>
                                    )}
                    ...
                    >
                        ...
                        <div className='rounded-lg border border-gray-300 p-4 sm:p-6 bg-[#fffefc] shadow-md'>
                            <h2 className='text-lg sm:text-xl font-semibold mb-3 sm:mb-4 text-[#860809] font-libre'>Shipping Details</h2>
                            ...
                            <div className='space-y-3 sm:space-y-4'>
                                ...
                                <div className='flex justify-between text-xs sm:text-sm border-t border-gray-200 pt-1.5 sm:pt-2'>
                                    ...
                                    <span className='text-[#030105] font-libre'>₱{subtotal.toLocaleString('en-PH', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                                </div>
                                ...
                                {isCouponApplied && coupon && (
                                    <div className='flex justify-between text-xs sm:text-sm gap-2'>
                                        ...
                                        <span className='text-green-600 font-libre flex-shrink-0'>
                                            -₱{(coupon.type === 'percent' ? subtotal * (coupon.amount / 100) : Math.min(coupon.amount, subtotal)).toLocaleString('en-PH', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                                        </span>
                                    </div>
                                )}
                                ...
                                {isCouponApplied && coupon && (
                                    <div className='flex justify-between text-xs sm:text-sm gap-2'>
                                        ...
                                        <span className='text-[#030105] font-libre flex-shrink-0'>
                                            ₱{(subtotal - (coupon.type === 'percent' ? subtotal * (coupon.amount / 100) : Math.min(coupon.amount, subtotal))).toLocaleString('en-PH', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                                        </span>
                                    </div>
                                )}
                                ...
                                {selectedShipping === 'lalamove' && lalamoveQuote && (
                                    <>
                                        <div className='flex justify-between text-xs sm:text-sm gap-2'>
                                            ...
                                            <span className='text-[#860809] font-libre flex-shrink-0'>{lalamoveQuote.serviceType}</span>
                                        </div>
                                        <div className='flex justify-between text-xs sm:text-sm gap-2'>
                                            <span className='text-[#030105] font-alice'>Distance</span>
                                            <span className='text-[#860809] font-libre flex-shrink-0'>{lalamoveQuote.distance?.toFixed(1) || 0} km</span>
                                        </div>
                                        <div className='flex justify-between text-xs sm:text-sm gap-2'>
                                            <span className='text-[#030105] font-alice'>Est. Time</span>
                                            <span className='text-[#860809] font-libre flex-shrink-0'>{Math.round(lalamoveQuote.duration || 0)} min</span>
                                        </div>
                                    </>
                                )}

                                <div className='border-t border-gray-300 pt-2 sm:pt-3'>
                                    <div className='flex justify-between font-semibold text-sm sm:text-base gap-2'>
