        ...
        <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <p className="text-sm sm:text-base text-[#030105] leading-relaxed mb-4 sm:mb-6">
              ...
              <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                <div className="bg-[#fffefc] p-4 sm:p-5 md:p-6 rounded-lg border border-[#a31f17]">
                  <h3 className="text-lg sm:text-xl font-bold text-[#860809] mb-3 sm:mb-4">Personal Details</h3>
                ...
                <div className="bg-[#fffefc] p-4 sm:p-5 md:p-6 rounded-lg border border-[#a31f17]">
                  <h3 className="text-lg sm:text-xl font-bold text-[#860809] mb-3 sm:mb-4">Verification Details</h3>
                  <ul className="list-disc pl-4 sm:pl-5 space-y-1.5 sm:space-y-2 text-sm sm:text-base text-[#030105]">
              ...
              <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                <div className="space-y-3 sm:space-y-4">
                  <div className="bg-[#f8f3ed] p-3 sm:p-4 rounded-lg border border-[#a31f17]">
                    <h3 className="text-base sm:text-lg font-bold text-[#860809] mb-2">Order Processing</h3>
                    <p className="text-sm sm:text-base text-[#030105]">To process and fulfill your orders efficiently</p>
                  </div>
                  <div className="bg-[#f8f3ed] p-3 sm:p-4 rounded-lg border border-[#a31f17]">
                    <h3 className="text-base sm:text-lg font-bold text-[#860809] mb-2">Communication</h3>
                    <p className="text-sm sm:text-base text-[#030105]">To communicate updates, order confirmations, and delivery notifications</p>
                  </div>
                </div>
                <div className="space-y-3 sm:space-y-4">
                  <div className="bg-[#f8f3ed] p-3 sm:p-4 rounded-lg border border-[#a31f17]">
                    <h3 className="text-base sm:text-lg font-bold text-[#860809] mb-2">Service Enhancement</h3>
                    <p className="text-sm sm:text-base text-[#030105]">To enhance our services and optimize your customer experience</p>
                  </div>
                  <div className="bg-[#f8f3ed] p-3 sm:p-4 rounded-lg border border-[#a31f17]">
                    <h3 className="text-base sm:text-lg font-bold text-[#860809] mb-2">Legal Compliance</h3>
                    <p className="text-sm sm:text-base text-[#030105]">To comply with legal obligations, including fraud prevention, auditing, and compliance reporting</p>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
              <motion.div 
                ...
                viewport={{ once: true }}
              >
                <h3 className="text-xl sm:text-2xl font-bold text-[#860809] mb-4 sm:mb-6">Data Protection Guarantee</h3>
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
              >
                <h3 className="text-xl sm:text-2xl font-bold text-[#860809] mb-4 sm:mb-6">Data Retention & Security</h3>
                <p className="text-sm sm:text-base text-[#030105] leading-relaxed mb-3 sm:mb-4">
        ...
        <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-xl sm:text-2xl font-bold text-[#860809] mb-4 sm:mb-6">Consent & Data Processing</h3>
              <p className="text-sm sm:text-base text-[#030105] leading-relaxed mb-3 sm:mb-4">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-xl sm:text-2xl font-bold text-[#860809] mb-4 sm:mb-6">Product Quality & Replacement Policy</h3>
              <p className="text-sm sm:text-base text-[#030105] leading-relaxed mb-3 sm:mb-4">
        ...
        <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-[#860809] mb-4 sm:mb-6">Contact Our Data Protection Officer</h2>
              <p className="text-sm sm:text-base text-[#030105] leading-relaxed mb-3 sm:mb-4">
