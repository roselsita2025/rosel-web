    ...
    <div className="min-h-screen bg-[#fffefc]">
            ...
            <div className="text-center">
              ...
              >
                <img 
                  src="/rosellogo.png" 
                  alt="Rosel Logo" 
                  className="h-32 w-48 sm:h-40 sm:w-60 md:h-50 md:w-72 drop-shadow-md" 
                />
              </motion.div>
              <motion.h2 
                className="text-3xl sm:text-4xl font-bold text-[#860809] mb-6 font-libre"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              <motion.div 
                className="max-w-4xl mx-auto space-y-6 text-[#030105] leading-relaxed text-base sm:text-lg font-alice"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, delay: 0.4 }}
                viewport={{ once: true }}
      ...
      >
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <motion.h2 
              className="text-3xl sm:text-4xl font-bold text-[#860809] text-center mb-12 font-libre"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.2 }}
              viewport={{ once: true }}
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <motion.div 
                className="text-center bg-[#f8f3ed] p-6 sm:p-8 rounded-xl shadow-lg"
                initial={{ opacity: 0, y: 50 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.1 }}
                viewport={{ once: true }}
              >
                ...
                <h3 className="text-lg sm:text-xl font-bold text-[#a31f17] mb-4 font-alice">Quality First</h3>
              ...
              >
                ...
                <h3 className="text-lg sm:text-xl font-bold text-[#a31f17] mb-4 font-alice">Customer Trust</h3>
                <p className="text-sm sm:text-base text-[#030105] font-libre">
              ...
              >
                ...
                <h3 className="text-lg sm:text-xl font-bold text-[#a31f17] mb-4 font-alice">Innovation</h3>
                <p className="text-sm sm:text-base text-[#030105] font-libre">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="relative overflow-hidden w-full">
              <div className="animate-scroll py-4" style={{ gap: '2rem' }}>
                ...
                <div className="flex-shrink-0 w-32 h-20 sm:w-36 sm:h-24 bg-[#fffefc] border-2 border-[#860809] rounded-lg flex items-center justify-center p-2">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
              {/* Card 1 - Good Pricing */}
              <motion.div 
                className="flex flex-col items-center p-6 rounded-lg bg-[#f8f3ed] border-2 border-[#860809]"
                initial={{ opacity: 0, y: 50 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.1 }}
                viewport={{ once: true }}
              >
                <div className="w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 bg-[#860809] rounded-lg mb-4 flex items-center justify-center">
                  <LucideTag className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 text-white" />
                </div>
                <h3 className="text-xl sm:text-xl lg:text-2xl font-bold text-[#a31f17] mb-3 text-center font-alice">Good Pricing</h3>
                <p className="text-sm sm:text-sm lg:text-base text-[#030105] text-center font-libre">Rosel Frozen Meat offers competitive prices without compromising on quality.</p>
              </motion.div>
              ...
              >
                <div className="w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 bg-[#860809] rounded-lg mb-4 flex items-center justify-center">
                  <LucideTruck className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 text-white" />
              </div>
                <h3 className="text-xl sm:text-xl lg:text-2xl font-bold text-[#a31f17] mb-3 text-center font-alice">Online Deliver</h3>
                <p className="text-sm sm:text-sm lg:text-base text-[#030105] text-center font-libre">Convenient online delivery service ensures customers get their orders fresh without waiting.</p>
              </motion.div>
              ...
              >
                <div className="w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 bg-[#860809] rounded-lg mb-4 flex items-center justify-center">
                  <LucideWarehouse className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 text-white" />
                </div>
                <h3 className="text-xl sm:text-xl lg:text-2xl font-bold text-[#a31f17] mb-3 text-center font-alice">Local Pick-Up</h3>
                <p className="text-sm sm:text-sm lg:text-base text-[#030105] text-center font-libre">Convenient same-day local pick-up ensures customers get their orders fresh without waiting.</p>
              </motion.div>
              ...
              >
                <div className="w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 bg-[#860809] rounded-lg mb-4 flex items-center justify-center">
                  <LucideCrown className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 text-white" />
              </div>
                <h3 className="text-xl sm:text-xl lg:text-2xl font-bold text-[#a31f17] mb-3 text-center font-alice">Prestige</h3>
                <p className="text-sm sm:text-sm lg:text-base text-[#030105] text-center font-libre">Trusted by loyal customers, Rosel upholds a reputation for quality and reliability in frozen goods.</p>
              </motion.div>
              </div>
            </div>
          </div>
