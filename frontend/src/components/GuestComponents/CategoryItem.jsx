...
const CategoryItem = ({ category, isActive = false }) => {
	return (
		<div className={`relative overflow-visible h-24 w-32 sm:h-28 sm:w-36 md:h-32 md:w-40 rounded-lg group shadow-lg transition-all duration-300 ease-in-out hover:scale-125 hover:z-50 hover:shadow-2xl hover:rounded-2xl ${isActive ? 'ring-4 ring-[#901414] ring-opacity-80' : ''}`}>
